...
public class QueryRowsMarkLogic extends AbstractMarkLogicProcessor {
	...
	public void onTrigger(ProcessContext context, ProcessSessionFactory sessionFactory) throws ProcessException {
		...
		try {
			...
			final String jsonPlan = context.getProperty(PLAN).evaluateAttributeExpressions(flowFile).getValue();
			final String mimeType = context.getProperty(MIMETYPE).evaluateAttributeExpressions(flowFile).getValue();
